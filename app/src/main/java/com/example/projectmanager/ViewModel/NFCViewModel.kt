...
class NFCViewModel:AndroidViewModel {
    ...
    private fun updateToast(message : String) { Coroutines.io(this@NFCViewModel, {
    ...
    //region NFC Methods
    public fun onCheckNFC(isChecked : Boolean) { Coroutines.io(this@NFCViewModel) {
    ...
    public fun readTag(tag : Tag?) { Coroutines.default(this@NFCViewModel) {
    ...
    public fun updateNFCStatus(status : NFCStatus) { Coroutines.io(this@NFCViewModel) {
